<div class="form-group">
    ...
    <div class="col-lg-9 bs-component">
        ...
        @if($line->editInEditor())
            <textarea name="trans[{{ $locale }}][{{ $line->id }}]" id="{{ $locale }}-{{ $line->id }}-inputValue" class="form-control" data-editor rows="5">{!! old('trans['.$locale.']['.$line->id.']',$line->getValue($locale,false)) !!}</textarea>
